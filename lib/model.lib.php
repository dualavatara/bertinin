...
require_once('field.lib.php');
require_once('filter.lib.php');
require_once('argument.lib.php');

require_once 'ModelData.php';
/**
 * require SQL command wrappers
 */
require_once("InsertSqlCmd.php");
require_once("UpdateSqlCmd.php");
require_once("DeleteSqlCmd.php");
require_once("SelectSqlCmd.php");
require_once("CallSqlCmd.php");
...
class Model extends ModelData {
    ...
    /**
     * @return TimestampSqlFilter
     */
    public function filterTime($fieldName){ return new TimestampSqlFilter($fieldName); }
